...
export const routes: Routes = [
  ...
  { path: 'mentees', component: MenteesListComponent, canActivate: [RoleGuard], data: { expectedRole: 'PERSONAL_TRAINER' } },
  { path: 'mentees/invite-mentee', component: InviteMenteeComponent, canActivate: [RoleGuard], data: { expectedRole: 'PERSONAL_TRAINER' } },
  { path: 'mentees/mentee-details/:id', component: MenteeDetailsComponent, canActivate: [RoleGuard], data: { expectedRole: 'PERSONAL_TRAINER' } },
  { path: 'workout-plan/create/:menteeId', component: WorkoutPlanCreateComponent, canActivate: [RoleGuard], data: { expectedRole: 'PERSONAL_TRAINER' } },
